...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './home.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOME_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOME actions', async () => {
      const expectedActions = [
        {
