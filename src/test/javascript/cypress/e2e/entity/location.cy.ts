...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="locID"]`).type('systems').should('have.value', 'systems');

      cy.get(`[data-cy="locName"]`).type('Human Fort Marketing').should('have.value', 'Human Fort Marketing');

      cy.get(`[data-cy="locDesc"]`).type('programming').should('have.value', 'programming');
