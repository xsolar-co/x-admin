...
/**
 * REST controller for managing {@link com.xsolar.admin.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                if (location.getLocID() != null) {
                    existingLocation.setLocID(location.getLocID());
                }
                if (location.getLocName() != null) {
                    existingLocation.setLocName(location.getLocName());
                }
                if (location.getLocDesc() != null) {
                    existingLocation.setLocDesc(location.getLocDesc());
                }
