...
import com.xsolar.admin.domain.Location;
import com.xsolar.admin.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    private static final String DEFAULT_LOC_ID = "AAAAAAAAAA";
    private static final String UPDATED_LOC_ID = "BBBBBBBBBB";

    private static final String DEFAULT_LOC_NAME = "AAAAAAAAAA";
    private static final String UPDATED_LOC_NAME = "BBBBBBBBBB";

    private static final String DEFAULT_LOC_DESC = "AAAAAAAAAA";
    private static final String UPDATED_LOC_DESC = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().locID(DEFAULT_LOC_ID).locName(DEFAULT_LOC_NAME).locDesc(DEFAULT_LOC_DESC);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().locID(UPDATED_LOC_ID).locName(UPDATED_LOC_NAME).locDesc(UPDATED_LOC_DESC);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLocName()).isEqualTo(DEFAULT_LOC_NAME);
        assertThat(testLocation.getLocDesc()).isEqualTo(DEFAULT_LOC_DESC);
    }
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].locID").value(hasItem(DEFAULT_LOC_ID)))
            .andExpect(jsonPath("$.[*].locName").value(hasItem(DEFAULT_LOC_NAME)))
            .andExpect(jsonPath("$.[*].locDesc").value(hasItem(DEFAULT_LOC_DESC)));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.locID").value(DEFAULT_LOC_ID))
            .andExpect(jsonPath("$.locName").value(DEFAULT_LOC_NAME))
            .andExpect(jsonPath("$.locDesc").value(DEFAULT_LOC_DESC));
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.locID(UPDATED_LOC_ID).locName(UPDATED_LOC_NAME).locDesc(UPDATED_LOC_DESC);
        ...
        assertThat(testLocation.getLocName()).isEqualTo(UPDATED_LOC_NAME);
        assertThat(testLocation.getLocDesc()).isEqualTo(UPDATED_LOC_DESC);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locID(UPDATED_LOC_ID).locDesc(UPDATED_LOC_DESC);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locID(UPDATED_LOC_ID).locName(UPDATED_LOC_NAME).locDesc(UPDATED_LOC_DESC);
